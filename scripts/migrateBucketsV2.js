/**
 * Migration script: Update bucket IDs to new workflow stages
 * naming → briefing
 * content → build
 */
...
console.log('📋 Migrating buckets to new workflow stages...\n');

const migrations = [
  { from: 'naming', to: 'briefing' },
  { from: 'content', to: 'build' }
];
...
console.log(`\n✅ Migrated ${totalMigrated} tasks to new bucket IDs.`);
