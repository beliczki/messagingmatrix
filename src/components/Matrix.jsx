...
const Matrix = ({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {showOrphanedDialog && orphanedMessages.length > 0 && (
                      ...
                      <button
                        onClick={() => {
                          if (correctingMessage?.id === msg.id) {
                            handleCorrectOrphanedMessage(msg, correctingMessage.newTopic, correctingMessage.newAudience);
                            setCorrectingMessage(null);
                          } else {
                            handleCorrectOrphanedMessage(msg, msg.topic, msg.audience);
                          }
                        }}
