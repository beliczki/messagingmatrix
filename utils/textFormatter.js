/**
 * Text Formatting Utility (Server-side Node.js version)
 *
 ...
 */
function applyTextFormattingSpans(text, formattingRules) {
 ...
 */
function applyTextFormatting(text, size, formattingRules) {
 ...
 */
function applyTextFormattingToMessage(message, size, formattingRules) {
...
module.exports = {
  applyTextFormatting,
  applyTextFormattingToMessage,
  applyTextFormattingSpans
};
